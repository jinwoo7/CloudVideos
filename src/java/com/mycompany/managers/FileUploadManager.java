...
import com.mycompany.jsfclasses.UserPhotoController;
...
public class FileUploadManager implements Serializable {
    ...
    public void handleFileUpload(FileUploadEvent event) throws IOException {
        ...
        try {
            ...
            try (InputStream inputStream = event.getFile().getInputstream();) {
                ...
                inputStreamToFile(inputStream, photoname);
                inputStream.close();
            }
            ...
            Create a new UserFile object with attibutes: (See UserFile table definition inputStream DB)
                ...
                <> user_id = user
             */
            UserPhoto newUserFile = new UserPhoto(user.getId(), photoname); //UserPhoto(Integer id, String extension)
            ...
            ==============================================================
             */
            List<UserPhoto> filesFound = getUserPhotoFacade().findPhotosByUserID(user.getId());
            ...
            if (!filesFound.isEmpty()) {
                ...
                getUserPhotoFacade().remove(filesFound.get(0));
            }

            //---------------------------------------------------------------
            //
            // Create the new UserFile entity (row) in the CloudDriveDB
            getUserPhotoFacade().create(newUserFile);

            // This sets the necessary flag to ensure the messages are preserved.
            FacesContext.getCurrentInstance().getExternalContext().getFlash().setKeepMessages(true);

            getUserPhotoController().refreshFileList();
     ...
     * @param data
     */
    public void setFileLocation(UserPhoto data) {

        String fileName = data.getThumbnailFileName();
