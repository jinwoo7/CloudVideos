...
public class User implements Serializable {
    ...
    @OneToMany(mappedBy = "userId")
    private Collection<UserVideo> userVideoCollection;
    ...
    @XmlTransient
    public Collection<UserVideo> getUserVideoCollection() {
        return userVideoCollection;
    }

    public void setUserVideoCollection(Collection<UserVideo> userVideoCollection) {
        this.userVideoCollection = userVideoCollection;
    }
